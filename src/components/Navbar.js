...
const Navbar = () => {
  ...
  return (
    <>
      <Flex p={{base:"14px 20px", md:"18px 24px"}} justifyContent="space-between" height="80px"  background="#FFF" boxShadow= "0px 8px 12px 0px rgba(0, 0, 0, 0.04)"
>
        <Flex alignItems="center">
          <HamburgerIcon mr="20px" display={{base:'none' , md:'block'}}/>
          <ChevronLeftIcon h="24px" w="48px" mr="9px" display={{base:'block',  md:'none'}}/>
        ...
        <Flex alignItems="center" display={{base:'none', md:'flex'}}>
          ...
          <Box borderLeft="1px" pl="23px" height="50px" >
            <Text fontWeight="400" textAlign="end">Mark Anderson</Text>
            <Flex>
              <Text fontSize="12px" opacity="0.6000000238418579" fontStyle="normal">Last Login:{formatDate(currentDate)}, {formatTime(currentTime)}</Text>
              <Box
                fontSize="12px"
                ml="9px"
